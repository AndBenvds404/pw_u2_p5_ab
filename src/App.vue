<template>
  ...
  <div class="container">
    ...
    <div class="juego"  v-if="mostrarJuego">
      ...
      <div class="cuadros">
        <Imagen  :urlImg="url1" :respuesta="texto1"></Imagen>
        <Imagen  :urlImg="url2" :respuesta="texto2"></Imagen>
        <Imagen  :urlImg="url3" :respuesta="texto3"> </Imagen>
      </div>
  ...
  methods:{
    ...
    evaluarResultado(){
      ...
      if(this.texto1==='yes' && this.texto2==='yes' && this.texto3==='yes' ){
        this.puntaje+=5
      }else if((this.texto1==='yes' && this.texto2==='yes') || (this.texto2==='yes' && this.texto3==='yes') || (this.texto1==='yes' && this.texto3==='yes') ){
        this.puntaje+=2
      }else{
        this.puntaje+=1
      }
